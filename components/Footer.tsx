      ...
      <div className="border-t border-[#3b6d11]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            {/* Instagram */}
            <a href="https://www.instagram.com/neetmcqs/" target="_blank" rel="noopener noreferrer"
              className="w-8 h-8 rounded-full border border-[#3b6d11] flex items-center justify-center text-[#e2ecb7] hover:bg-[#3b6d11] transition-colors"
            ...
            {/* YouTube */}
            <a href="https://www.youtube.com/@mcqsneet" target="_blank" rel="noopener noreferrer"
              className="w-8 h-8 rounded-full border border-[#3b6d11] flex items-center justify-center text-[#e2ecb7] hover:bg-[#3b6d11] transition-colors"
              aria-label="YouTube">
              <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
            ...
            {/* Facebook */}
            <a href="https://www.facebook.com/neetmcqsfb/" target="_blank" rel="noopener noreferrer"
              className="w-8 h-8 rounded-full border border-[#3b6d11] flex items-center justify-center text-[#e2ecb7] hover:bg-[#3b6d11] transition-colors"
              aria-label="Facebook">
              <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
            ...
            {/* LinkedIn */}
            <a href="https://www.linkedin.com/in/yashdhage/" target="_blank" rel="noopener noreferrer"
              className="w-8 h-8 rounded-full border border-[#3b6d11] flex items-center justify-center text-[#e2ecb7] hover:bg-[#3b6d11] transition-colors"
              aria-label="LinkedIn">
              <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
